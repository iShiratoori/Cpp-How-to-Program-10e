...
//Your class should have a constructor with three parameters that uses the parameters 
//to initialize the three data members. For the purpose of this exercise, 
//assume that the values provided for the year and day are correct, but ensure
//that the month value is in the range 1–12; if it isn’t, set the month to 1. 

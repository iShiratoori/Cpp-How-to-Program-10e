...
{
    m_person.setFirstName(person.getFirstName());
    m_person.setMiddeName(person.getMiddeName());
    m_person.setLastName(person.getLastName());
    m_person.setSalutation(person.getSalutation());
}
